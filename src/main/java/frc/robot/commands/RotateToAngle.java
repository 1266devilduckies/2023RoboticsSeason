...
public class RotateToAngle extends CommandBase {
        ...
        double m_angle;
        PIDController pidController = new PIDController(0.1, 0.1, 0.004);
        public RotateToAngle(DrivetrainSubsystem drivetrain, double angle) {
                m_drivetrainSubsystem = drivetrain;
                m_angle = angle;
                pidController.setTolerance(0.1, 2); //0.5 degree tolerance, changing at a rate of 2 degrees per second
